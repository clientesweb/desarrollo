...
const Header = () => {
  ...
  return (
    <nav
      className={`py-3 px-[5%] top-0 w-full fixed flex items-center justify-between z-20 ${headerBackground} transition-all duration-300 special-font`}
    >
