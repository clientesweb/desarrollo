    ...
    <main className="px-[5%] py-[100px] grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <section className="flex items-center justify-center gap-4 mt-10 md:mt-0 special-font">
        <div className="relative">
          <div
            className="p-4 rounded-xl shadow-lg bg-background-light w-[85%] md:w-[70%] grid gap-3 relative z-10 border border-primary/20"
            data-aos="fade-down"
          >
            <Image
          ...
          <div
            className="p-4 rounded-xl shadow-sm border border-primary/10 bg-background-light/80 w-[85%] md:w-[70%] grid gap-3 absolute left-[50px] top-[70px]"
            data-aos="fade-down"
          >
            <Image
