      ...
      <section className="" data-aos="fade-down">
        <div className="flex justify-between flex-wrap gap-2">
          ...
          <div className="grid gap-4">
            <h1 className="text[18px] text-accent font-extrabold">Company</h1>
          ...
          <div className="grid gap-4">
            <h1 className="text[18px] text-accent font-extrabold">Contact</h1>
          ...
          <div className="grid gap-4">
            <h1 className="text[18px] text-accent font-extrabold">Services</h1>
          ...
          <div className="flex flex-col gap-4 items-center md:items-start justify-center md:justify-start w-full md:w-auto mt-5 md:mt-0">
            ...
            <p className="text-[20px] text-accent font-bold">Download our app</p>
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center justify-center gap-1 bg-background py-2 px-5 rounded-full cursor-pointer hover:bg-primary/10 transition-colors duration-300">
                ...
                <div>
                  <h3 className="text-[13px] font-extrabold text-accent">GET IT ON</h3>
              ...
              <div className="flex items-center justify-center gap-1 bg-background py-2 px-5 rounded-full cursor-pointer hover:bg-primary/10 transition-colors duration-300">
                ...
                <div>
                  <h3 className="text-[11px] font-semibold text-muted">Available on the</h3>
                  <p className="text-[13px] font-extrabold text-accent">Apple Store</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <p className="text-[14px] text-muted text-center font-normal mt-5 ">All rights reserved@dualitydomain.com</p>
      </section>
    </main>
  )
}
